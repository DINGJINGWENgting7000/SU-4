...
Dim_site = 6  ## Define the dimension of Hilbert space in a site.
Lx = 4
Ly = 3
N = Lx*Ly  ## Define the number of sites in the chain
n_in_cell = 1 ## Define the number of sublattices in a cell for triangular lattice
...
#  AutoMPO 
function build_h_2d(sites; Lattice, Lx,Ly, J1=1.0, J2=1.0, J3=1.0, J4=1.0, J5=1.0, J6=1.0, J7=1.0, J8=1.0, J9=1.0)
    N = length(sites)  # system size
    @assert N == Lx*Ly
...
# Hamiltonian
H = build_h_2d(sites; Lattice = Lattice_triangle , Lx=Lx, Ly=Ly, J1=1.0, J2=1.0, J3=1.0, J4=1.0, J5=1.0, J6=1.0, J7=1.0, J8=1.0, J9=1.0)
